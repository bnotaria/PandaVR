...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="fluid-container">
		...
		<div class="spacer">
			<p>
				While one player uses the HTC vive tracked controllers to build a fort, as in <a href="/VRMinimap.aspx">the VR minimap</a>, another user can view the fort. This is achieved with two separate programs, the VR fort demo and a phone viewer. For development I used a webcam attached to my computer for the phone. The "phone" viewer is also written in Unity3d with the help of <a href="https://www.hitl.washington.edu/artoolkit/">the ARToolkit</a>. This worked for under Idea circumstances but ultimately was not meant for Unity.
			</p>
			<p>
			...
			<p>
				The Network communication right now is hardcoded IPs. This is good in a test envirment but should be switched to another solution. Possibly the VR host displaying a QR code with the host IP, being that this is only meant for LAN. 
			</p>
			<p>
