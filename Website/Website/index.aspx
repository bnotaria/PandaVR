...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="well frontpageContent row">
			...
			<div class="leftPane col-xs-6">
				<blockquote class="imgur-embed-pub" lang="en" data-id="JwU9C0j"><a href="//imgur.com/JwU9C0j"></a></blockquote>
			...
			<div class="rightPane col-xs-6">
				...
				<div class="rightPoint">
					<strong>Approach:</strong>
					<p>Used an augment reality SDK and tag on a table, then project the minimap content on top.</p>
				</div>
			</div>
		</div>
		<div class="well frontpageContent row">
			<h2><a href="/Reddot.aspx">Virtual Reality Holographic Scope</a></h2>
			<div class="leftPane col-xs-6">
				<a href="http://imgur.com/vWfaZKz">
					<img src="http://i.imgur.com/vWfaZKz.png" title="source: imgur.com" /></a>
			</div>
			<div class="rightPane col-xs-6">
				<div class="rightPoint">
					<strong>Language:</strong>
		...
		<div class="well frontpageContent row">
			...
			<div class="rightPane col-xs-6">
				...
				<div class="rightPoint">
					<strong>Approach:</strong>
					<p>The project was split into two parts: Protocol design and Gesture Recognition. The Protocal uses 1 gesture and menu system. The Gestoure recognition use SVD and k nearest neigbors.</p>
				</div>
			</div>
		</div>
